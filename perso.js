...
function ajout_panier(){
  ...
  for (let i=0; i<panier.length;i++){
    ...
    alert(sessionStorage.getItem("liste_produits_panier"));
    liste_produits=document.getElementById("panier");
    nouveau_produit = document.createElement('produit');
    liste_produits.appendChild(nouveau_produit);
    nouveau_produit.innerHTML= new_product.name;
    nouvelle_qte = document.createElement('qte');
    liste_produits.appendChild(nouvelle_qte);
