...
promise.then(function(ours){
    ...
    bouton_ajout_panier.addEventListener("click",function(){
      ...
      let name=document.querySelector("#Bear h2 span.name").innerHTML;
      let qty=parseInt(document.getElementById("qt").value,10);
      let price=document.querySelector("#Bear .prix span").innerHTML;
      Panier.add(id,name,qty,price);
    });
};
